...
<html>
 <head>
  <title>S&G D1-R1 WebRadio v2</title>
  <meta http-equiv="content-type" content="text/html; charset=ISO-8859-1">
  <link rel="Shortcut Icon" type="image/ico" href="favicon.ico">
 </head>
 <body>
  <ul>
   <li><a class="pull-left" target="blank" href="https://srotogargees.business.site/">Sroto&Gargees</a></li>
   <li><a class="pull-left active" href="/index.html">Control</a></li>
   <li><a class="pull-left" href="/config.html">Setup</a></li>
   <li><a class="pull-left" href="/about.html">About</a></li>
  </ul>
  <br><br><br>
  <center>
      <h1>----- Sroto&Gargees D1-R1 WebRadio v2 -----</h1>
   ...
   <br>
   <p>Find new presets : <a target="blank" href="http://www.internet-radio.com">www.internet-radio.com</a></p>
	<p>The content of this site is licensed under GNU GENERAL PUBLIC LICENSE</p> 
  </center>
  <script>
